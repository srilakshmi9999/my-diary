...
<head>
    <style>
	   h2.pageTitle{
		   font-family: "Pacifico", cursive; font-size: 55px; font-style: normal; font-variant: normal;
	   }
...
<div class="left col-md-11">
	<h2 class="pageTitle">All About Today!!</h2>
	<form action="#" method="POST" class="newNote" id="mainForm" autocomplete="off">
